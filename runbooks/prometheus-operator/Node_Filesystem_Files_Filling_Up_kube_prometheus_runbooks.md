---
id: Node_Filesystem_Files_Filling_Up_kube_prometheus_runbooks
category: kubernetes
fault_type: disk
severity: warning
source: prometheus-operator-runbooks
source_url: https://runbooks.prometheus-operator.dev/runbooks/node/nodefilesystemfilesfillingup/
---

# Node Filesystem Files Filling Up | kube-prometheus runbooks
...
space. The alert fires at a
critical
level when the filesystem is predicted to
...
and
mountpoint
labels from the alert. You can graph the
...
=
"
<value of mountpoint label from alert>
"
}
...
for additional mitigation steps.
