---
id: Kubelet_Down_kube_prometheus_runbooks
category: kubernetes
fault_type: unknown
severity: warning
source: prometheus-operator-runbooks
source_url: https://runbooks.prometheus-operator.dev/runbooks/kubernetes/kubeletdown/
---

# Kubelet Down | kube-prometheus runbooks
...
debugging tools are likely not functional, e.g.
kubectl exec
and
kubectl logs
.
Diagnosis
#
Check the status of nodes and for recent events on
Node
