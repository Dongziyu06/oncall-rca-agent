---
id: Prometheus_Duplicate_Timestamps_kube_prometheus_runbooks
category: kubernetes
fault_type: unknown
severity: warning
source: prometheus-operator-runbooks
source_url: https://runbooks.prometheus-operator.dev/runbooks/prometheus/prometheusduplicatetimestamps/
---

# Prometheus Duplicate Timestamps | kube-prometheus runbooks
...
warn ts
=
2021-01-04T15:08:55.613Z caller
=
scrape.go:1372 component
=
"scrape manager"
scrape_pool
=
default/main-ingress-nginx-controller/0 target
=
http://10.0.7.3:10254/metrics msg
=
...
or
PodMonitor
object, which can be identified through
the
scrape_pool
label in the log line, which is in the format of
