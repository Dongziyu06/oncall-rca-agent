---
id: Etcd_Grpcrequests_Slow_kube_prometheus_runbooks
category: kubernetes
fault_type: timeout
severity: warning
source: prometheus-operator-runbooks
source_url: https://runbooks.prometheus-operator.dev/runbooks/etcd/etcdgrpcrequestsslow/
---

# Etcd Grpcrequests Slow | kube-prometheus runbooks

Etcd Grpcrequests Slow | kube-prometheus runbooks
Etcd Grpcrequests Slow
...
rate
(
grpc_server_handling_seconds_bucket{job
=~
"
.*etcd.*
", grpc_type
...
irate
(
etcd_disk_wal_fsync_duration_seconds_bucket{job
=
"
etcd
"}[
...
Further info on etcd best practices can be found in the
etcdPractices
.
