---
id: Target_Down_kube_prometheus_runbooks
category: kubernetes
fault_type: unknown
severity: warning
source: prometheus-operator-runbooks
source_url: https://runbooks.prometheus-operator.dev/runbooks/general/targetdown/
---

# Target Down | kube-prometheus runbooks
...
#
/targets
page in Prometheus UI can be used to check the scrape error for the particular target.
up == 0
query can be used to check the trend over time.
Mitigation
#
