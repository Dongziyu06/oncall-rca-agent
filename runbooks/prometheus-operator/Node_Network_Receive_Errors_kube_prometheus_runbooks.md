---
id: Node_Network_Receive_Errors_kube_prometheus_runbooks
category: kubernetes
fault_type: network
severity: warning
source: prometheus-operator-runbooks
source_url: https://runbooks.prometheus-operator.dev/runbooks/node/nodenetworkreceiveerrs/
---

# Node Network Receive Errors | kube-prometheus runbooks
